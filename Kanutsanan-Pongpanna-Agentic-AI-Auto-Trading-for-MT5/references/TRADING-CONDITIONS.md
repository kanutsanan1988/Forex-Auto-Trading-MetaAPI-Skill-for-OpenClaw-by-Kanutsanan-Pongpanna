...
2. **TradingView Scanner API:** Technical indicators and recommendations.
...
The OpenRouter AI (Gemini 2.5 Flash) analyzes the market data and returns a decision (BUY/SELL/SKIP) along with a "Strength" score from 1 to 10.
...
## 5. Smart Lot Sizing & Margin Checks
...
- **Risk/Reward Enforcement:** The system enforces a rule where the Take Profit distance (in points) cannot exceed the Stop Loss distance. This ensures a minimum 1:1 risk-to-reward ratio.
