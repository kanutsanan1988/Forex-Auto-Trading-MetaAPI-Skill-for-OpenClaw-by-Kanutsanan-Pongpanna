...
REM   โหมด 1 = เทรดด้วยสัญญาณภายใน (Python; ปิด AI ทั้งหมดในวงจรระบบ)
REM   โหมด 2 = เทรดร่วมสัญญาณ AI (AI ทุกส่วนที่เชื่อมกับระบบ) — ค่าเริ่มต้น
REM  สลับสถานะงาน Python/AI ตามโหมด; ไม่เริ่ม/หยุดตัวเทรดและไม่แก้สิทธิ์ Live
REM ============================================================
chcp 65001 >nul
setlocal
cd /d "%~dp0"
